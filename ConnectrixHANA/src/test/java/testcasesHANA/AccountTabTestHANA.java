...
public class AccountTabTestHANA extends TestBase {
	...
	@Test(priority=1,enabled=true,dataProvider="getDataForAccount")  // NOTE:Define Account Name at upper part
	     public void Create_Account(String AccName,String ContactP, String Designation, String Mobile, String Email,String Source,String NatureOfIndustry,String TurnOver,String AccountOverview) throws InterruptedException   
	{
	  ...
	  @Test(priority=2,enabled=true,dataProvider="getDataForWONOppO") 
	     public void Create_WON_Opp(String Acc_Name,String CheckInType,String Oppn_Name,String Branch,String OppOwner,String ContactPerson,String Amount,String NatureOfIndustry,String Rating,String Comment) throws InterruptedException
	  {
	        ...
	        { 
				...
				/*
				 * case "HO":
				 * driver.findElements(By.id("com.uneecops.sapsalesapp:id/checkbox")).get(1).
				 * click();
				 * 
				 * System.out.println("HO Selected"); break;
				 */
	            case "GURGAON": 
	            	driver.findElements(By.id("com.uneecops.sapsalesapp:id/checkbox")).get(1).click(); 
	            	System.out.println("Gurgaon Selected");
	                break; 
	            ...
	            default: 
	            	driver.findElements(By.id("com.uneecops.sapsalesapp:id/checkbox")).get(0).click();  
	            	System.out.println("Default Delhi Selected");
	        } 
	     ...
	     public void Create_OPEN_Opp(String Acc_Name,String CheckInType,String Oppn_Name,String OppOwner,String contactPerson,String Amount,String NatureOfIndustry,String Rating,String Comment) throws InterruptedException 
	{
		 ...
		 public void Create_LOST_Opp(String Acc_Name,String CheckInType,String Oppn_Name,String OppOwner,String contactPerson,String Reason,String Amount,String NatureOfIndustry,String Comment) throws InterruptedException 
		{
	...
	//******************Non-Mandatory Field Entered**************//
	  ...
	  @Test(priority=5,enabled=true,dataProvider="getDataForOrder")
	     public void Create_Order(String Acc_Name,String Oppn_Name,String Device,String Quantity,String DiscountPercentage, String PO) throws InterruptedException    
	     {  
		    System.out.println("Placing order on WON Opportunity: "+Oppn_Name+" on the Account: "+Acc_Name);
	 	    driver.findElement(By.id("com.uneecops.sapsalesapp:id/navigation_accounts")).click(); // Accounts icon	
	 	    System.out.println("Entered into Account Section");
			Thread.sleep(500);
			driver.findElement(By.id("com.uneecops.sapsalesapp:id/button8")).click();  		
	     ...
	     public void verifyAccountDetails(String AccName,String ContactP, String Designation, String Mobile, String Email,String Source,String NatureOfIndustry,String TurnOver,String AccountOverview) throws InterruptedException
            ...
            System.out.println("Designation in the App: "+DesignationInApp);
			     ...
			     Thread.sleep(3000);
			     driver.findElement(By.id("com.uneecops.sapsalesapp:id/page_title")).click();
